.class public Lpl/mkexplorer/kormateusz/FileFunction;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lpl/mkexplorer/kormateusz/FileFunction$SetRingtone;
    }
.end annotation
...
.method public static getBytesSize(Ljava/lang/Long;)Ljava/lang/String;
    .locals 14
...
.method private static isIntentActivityAvailable(Landroid/content/Context;Landroid/content/Intent;)Z
    .locals 3
...
.method public static openFile(Landroid/content/Context;Ljava/io/File;)V
    ...
    :goto_0
    invoke-static {p0, v1}, Lpl/mkexplorer/kormateusz/FileFunction;->startActivityOrWarn(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v2, "application/html"
...
.method public static remountDialog(Landroid/content/Context;Lpl/mkexplorer/kormateusz/RootFile;Ljava/lang/String;)V
    .locals 13

    sput-object p0, Lpl/mkexplorer/kormateusz/FileFunction;->_context:Landroid/content/Context;

    sget-object v10, Lpl/mkexplorer/kormateusz/FileFunction;->_context:Landroid/content/Context;
    ...
    new-instance v10, Lpl/mkexplorer/kormateusz/FileFunction$1;

    invoke-direct {v10, v1}, Lpl/mkexplorer/kormateusz/FileFunction$1;-><init>(Landroid/app/AlertDialog;)V

    invoke-virtual {v3, v10}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v10, Lpl/mkexplorer/kormateusz/FileFunction$2;

    invoke-direct {v10, p1, p2, v1}, Lpl/mkexplorer/kormateusz/FileFunction$2;-><init>(Lpl/mkexplorer/kormateusz/RootFile;Ljava/lang/String;Landroid/app/AlertDialog;)V
...
.method public static setAsRingtone(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2

    new-instance v0, Lpl/mkexplorer/kormateusz/FileFunction$SetRingtone;

    invoke-direct {v0, p0, p1}, Lpl/mkexplorer/kormateusz/FileFunction$SetRingtone;-><init>(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static setAsWallpaper(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v2}, Lpl/mkexplorer/kormateusz/FileFunction;->startActivityOrWarn(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private static showUnavailabilityInfo(Landroid/content/Context;)V
    .locals 2
...
.method public static startActivityOrWarn(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lpl/mkexplorer/kormateusz/FileFunction;->isIntentActivityAvailable(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    :cond_0
    invoke-static {p0}, Lpl/mkexplorer/kormateusz/FileFunction;->showUnavailabilityInfo(Landroid/content/Context;)V
